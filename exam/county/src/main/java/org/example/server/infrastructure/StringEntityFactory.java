...
//  }
  ...
  public static String scannerToFileLine(ScannerDto scannerDto) {
    String delimiter = ",";
    return
        scannerDto.getName() + delimiter + scannerDto.getCountyId() + delimiter + scannerDto.getA() + delimiter + scannerDto.getB() + delimiter + scannerDto.getC();
  }
//
